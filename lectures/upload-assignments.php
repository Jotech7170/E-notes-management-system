                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Upload Assignments</a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body" style="margin: 12px; padding:20px;">
                                    ...
                                    <?php  } ?>
                                    <h5 class="card-title">Assigments</h5>
                                    <form class="form-group" enctype="multipart/form-data" method="POST" action="../includes/upload_assignment.php">
                                        ...
                                        <button class="mt-1 btn btn-warning" type="submit" name="upload_assignment">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
