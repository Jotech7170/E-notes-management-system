                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Upload Notes</a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body" style="margin: 12px; padding:20px;">
                                    ...
                                    <form class="form-group" enctype="multipart/form-data" method="POST" action="../includes/upload_notes.php">
                                        ...
                                        <button class="mt-1 btn btn-warning" type="submit" name="upload_notes">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
