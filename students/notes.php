                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">View Notes</a>
                        </div>
                                ...
                                <div class="fixed-table-body">
                                    ...
                                    <table id="fresh-table" class="table table-hover table-striped" style="margin-top: 0px;">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM resources WHERE type='notes' AND program='$program' AND level='$level'";
                                            $results = mysqli_query($con, $sql);

                                            if (mysqli_num_rows($results) < 1) {
                                                echo '<div class="alert alert-warning">No notes uploaded</div>';
                                            } else {
                                            ...
                                            ?>
                                                    <tr data-index="0">
                                                        ...
                                                        <!-- <td><button class="btn btn-warning">
                                                            <a href="<?php echo '../' . $row['filepath']; ?>"> Read-document</a>
